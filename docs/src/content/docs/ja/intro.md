---
title: Holloとは？
description: Holloは一人様向けの連合マイクロブログソフトウェアです。
---

Holloはあなただけの小さなインターネット空間を作ることができる簡単な一人様向けマイクロブログです。
...
（モデレーションツールなど）一人様向けインスタンスには必要ない機能は除外されています。
つまり、次のようなことができます：
...
という単語に由来しています。一人様向けのソフトウェアであるため、このような名前が付けられました。
